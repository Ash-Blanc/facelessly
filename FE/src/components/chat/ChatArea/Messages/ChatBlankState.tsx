...
const ActionButton = ({ href, variant, text }: ActionButtonProps) => {
    const baseStyles =
        'px-4 py-2 text-sm transition-colors font-mono tracking-tight'
    const variantStyles = {
        primary: 'border border-base-300 hover:bg-base-300 rounded-xl'
    }
                                ...
                                {TECH_ICONS.map((icon) => (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <motion.div
                                                className="pointer-events-none absolute bottom-full left-1/2 mb-1 -translate-x-1/2 transform whitespace-nowrap rounded bg-base-300 px-2 py-1 text-xs text-primary"
