...
const ReferenceItem: FC<ReferenceItemProps> = ({ reference }) => (
    <div className="relative flex h-[63px] w-[190px] cursor-default flex-col justify-between overflow-hidden rounded-md bg-base-200 p-3 transition-colors hover:bg-base-200/80">
...
const Reasoning: FC<ReasoningStepProps> = ({ index, stepTitle }) => (
    <div className="flex items-center gap-2 text-base-content/80">
        <div className="flex h-[20px] items-center rounded-md bg-base-200 p-2">
...
const ToolComponent = memo(({ tools }: ToolCallProps) => (
    <div className="cursor-default rounded-full bg-base-300 px-2 py-1.5 text-xs">
        <p className="font-mono uppercase text-primary/80">{tools.tool_name}</p>
    </div>
))
