    ...
    return (
        <div className="relative mx-auto mb-1 flex w-full max-w-2xl items-end justify-center gap-x-2 font-sans">
            <TextArea
                ...
                className="w-full border border-base-300 bg-base-200 px-4 text-sm text-base-content focus:border-primary/50"
            ...
            <Button
                ...
                size="icon"
                className="rounded-xl bg-primary p-5 text-primary-content"
            >
                <Icon type="send" color="primary-content" />
            </Button>
        </div>
    )
}
