...
export function EntitySelector() {
    ...
    if (currentEntities.length === 0) {
        return (
            <Select disabled>
                <SelectTrigger className="h-9 w-full rounded-xl border border-base-300 bg-base-200 text-xs font-medium uppercase opacity-50">
    ...
    return (
        ...
        >
            <SelectTrigger className="h-9 w-full rounded-xl border border-base-300 bg-base-200 text-xs font-medium uppercase">
                <SelectValue placeholder={placeholder} />
            </SelectTrigger>
            <SelectContent className="border-none bg-base-200 font-mono shadow-lg">
