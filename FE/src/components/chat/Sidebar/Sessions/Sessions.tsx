...
const Sessions = () => {
    ...
    return (
        <div className="w-full">
            ...
            <div
                className={`h-[calc(100vh-345px)] overflow-y-auto font-sans transition-all duration-300 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar]:transition-opacity [&::-webkit-scrollbar]:duration-300 ${isScrolling
                        ? '[&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-base-200 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:opacity-0'
